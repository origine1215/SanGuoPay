package com.sanguo.payment.alipay.util;

import com.sanguo.payment.alipay.config.Config;
import com.sanguo.payment.alipay.sign.MD5;
...
public class Submit {
    ...
    public static String query_timestamp() throws MalformedURLException,
        ...
        String strUrl = ALIPAY_GATEWAY_NEW + "service=query_timestamp&partner=" + Config.partner + "&_input_charset" + Config.input_charset;
